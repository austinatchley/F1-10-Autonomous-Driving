...
template <typename Derived>
void DrawEigen2DLine(const Eigen::DenseBase<Derived>& v1, const Eigen::DenseBase<Derived>& v2,
...
template <typename Derived>
void DrawEigen2DLine(const Eigen::DenseBase<Derived>& v1, const Eigen::DenseBase<Derived>& v2,
                     const std_msgs::ColorRGBA& c, visualization_msgs::Marker* msg) {
  msg->points.push_back(Eigen2DToRosPoint<Derived>(v1));
  msg->points.push_back(Eigen2DToRosPoint<Derived>(v2));
...
template <typename Derived>
void DrawEigen2DLine(const Eigen::DenseBase<Derived>& v1, const Eigen::DenseBase<Derived>& v2,
                     const std_msgs::ColorRGBA& c1, const std_msgs::ColorRGBA& c2,
                     visualization_msgs::Marker* msg) {
  msg->points.push_back(Eigen2DToRosPoint<Derived>(v1));
  msg->points.push_back(Eigen2DToRosPoint<Derived>(v2));
...
void DrawCross(const Vector2& v, const float size, const std_msgs::ColorRGBA& color,
               visualization_msgs::Marker* msg) {
