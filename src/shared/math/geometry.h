...
// to p4
template <typename T>
bool IsParallel(const Eigen::Matrix<T, 2, 1>& p1, const Eigen::Matrix<T, 2, 1>& p2,
                const Eigen::Matrix<T, 2, 1>& p3, const Eigen::Matrix<T, 2, 1>& p4) {
...
template <typename T>
void GetTangentPoints(const Eigen::Matrix<T, 2, 1>& p, const Eigen::Matrix<T, 2, 1>& c, const T& r,
                      Eigen::Matrix<T, 2, 1>* right_tangent, Eigen::Matrix<T, 2, 1>* left_tangent) {
...
template <typename T>
bool CheckLineLineCollision(const Eigen::Matrix<T, 2, 1>& a0, const Eigen::Matrix<T, 2, 1>& a1,
...
template <typename T>
Eigen::Matrix<T, 2, 1>
LineLineIntersection(const Eigen::Matrix<T, 2, 1>& a0, const Eigen::Matrix<T, 2, 1>& a1,
                     const Eigen::Matrix<T, 2, 1>& b0, const Eigen::Matrix<T, 2, 1>& b1) {
...
template <typename T>
std::pair<bool, Eigen::Matrix<T, 2, 1>>
CheckLineLineIntersection(const Eigen::Matrix<T, 2, 1>& a0, const Eigen::Matrix<T, 2, 1>& a1,
                          const Eigen::Matrix<T, 2, 1>& b0, const Eigen::Matrix<T, 2, 1>& b1) {
...
void ProjectPointOntoLineSegment(const Eigen::Matrix<T, 2, 1>& point,
                                 const Eigen::Matrix<T, 2, 1>& vertex_a,
                                 const Eigen::Matrix<T, 2, 1>& vertex_b,
                                 Eigen::Matrix<T, 2, 1>* projected_point, float* squared_distance) {
...
bool FurthestFreePointCircle(const Eigen::Matrix<T, 2, 1>& line_start,
                             const Eigen::Matrix<T, 2, 1>& line_end,
                             const Eigen::Matrix<T, 2, 1>& circle_center, const T radius,
                             T* squared_distance, Eigen::Matrix<T, 2, 1>* free_point) {
  bool collides = false;
...
template <typename T>
T MinDistanceLineLine(const Eigen::Matrix<T, 2, 1>& a0, const Eigen::Matrix<T, 2, 1>& a1,
                      const Eigen::Matrix<T, 2, 1>& b0, const Eigen::Matrix<T, 2, 1>& b1) {
  if (CheckLineLineCollision(a0, a1, b0, b1)) {
    return 0;
  }
...
template <typename T>
T MinDistanceLineArc(const Eigen::Matrix<T, 2, 1>& l0, const Eigen::Matrix<T, 2, 1>& l1,
                     const Eigen::Matrix<T, 2, 1>& a_center, const T& a_radius, T a_angle_start,
                     T a_angle_end, const int rotation_sign) {
  ...
  if (l0_dir.squaredNorm() < Sq(a_radius) && l1_dir.squaredNorm() >= Sq(a_radius)) {
    ...
    if (direction_line_intersects_arc(proj_center_line, along_line_dist, a_angle_start, a_angle_end,
